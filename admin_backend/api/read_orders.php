...
try {
    // ✅ Fetch all orders with joins to display readable data instead of IDs
    // Exclude orders with "For Approval" status (OrderStatusID = 1) - these should only appear in dashboard
    $sql = "
        SELECT 
            o.OrderID,
